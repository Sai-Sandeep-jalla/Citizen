...
export const Dashboard = () => {
  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      {/* Citizen Hero Banner */}
      <div className="bg-gradient-to-br from-[#0B1E47] via-[#1D4ED8] to-[#0B1E47] text-white rounded-3xl p-8 shadow-xl shadow-blue-900/10 relative overflow-hidden flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div className="space-y-1 z-10">
          ...
          <p className="text-xs sm:text-sm text-blue-200 font-medium">
            {t('welcome') || 'Welcome back'}{user?.name ? <>, <span className="text-[#F97316] font-bold">{user.name}</span>!</> : '!'} {t('trackAllComplaints') || 'Track all your complaints and requests here.'}
          </p>
        </div>
