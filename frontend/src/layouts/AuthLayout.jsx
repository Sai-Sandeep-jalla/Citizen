      ...
      <div className="absolute top-4 right-4 z-30">
        ...
        >
          ...
          >
            ...
            <option value="hi" className="text-gray-900 bg-white">Hindi/हिंदी</option>
            <option value="te" className="text-gray-900 bg-white">Telugu/తెలుగు</option>
            <option value="bn" className="text-gray-900 bg-white">Bengali/বাংলা</option>
            <option value="mr" className="text-gray-900 bg-white">Marathi/मराठी</option>
            <option value="ta" className="text-gray-900 bg-white">Tamil/தமிழ்</option>
            <option value="gu" className="text-gray-900 bg-white">Gujarati/ગુજરાતી</option>
            <option value="kn" className="text-gray-900 bg-white">Kannada/ಕನ್ನಡ</option>
            <option value="ml" className="text-gray-900 bg-white">Malayalam/മലയാളം</option>
            <option value="ur" className="text-gray-900 bg-white">Urdu/اردو</option>
          </select>
        </div>
      </div>
